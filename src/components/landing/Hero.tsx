  ...
  return <section className="section-padding min-h-[85vh] flex items-center px-6 md:px-8 lg:px-12 -mt-16 pt-16">
      <div className="container-wide">
        <div className="max-w-3xl py-0 my-0 mx-0">
          ...
          }} className="block text-accent tracking-[-0.02em] font-display -mt-6 md:-mt-8 skew-x-[-3deg] italic animate-slide-up [animation-delay:500ms] opacity-0 text-[3.5rem] md:text-6xl text-left leading-[0.8] md:leading-[0.85]">
              Start when they are.
            </span>
          </h1>
